...
public class ExcelToCsv {
    ...
    private final static String SCR_DIR = "./excel/xls";
    private final static String DEST_DIR = "./excel/csv";
    ...
    public static void main(String[] args) throws Exception {
        File excel = new File(SCR_DIR);
        File csv = new File(DEST_DIR);
        new ExcelToCsv(excel, csv);
    }
